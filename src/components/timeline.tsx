...
export function Timeline() {
  ...
  return (
    <div className="bg-background border-border border-t">
      ...
      <div className="bg-muted border-border flex h-12 items-center overflow-x-auto border-b px-4">
        <div
          className="flex min-w-full items-center"
          style={{ gap: `${pixelSpacing}px` }}
        >
      ...
      <div className="bg-background min-h-64 flex-1">
        {/* Video Track */}
        <div className="border-border bg-muted/30 flex h-20 items-center border-b px-4">
        ...
        {/* Audio Track */}
        <div className="border-border bg-muted/20 flex h-20 items-center border-b px-4">
          <div className="text-muted-foreground w-24 text-xs font-medium">
            Audio
          </div>
          <div className="relative h-full flex-1">
            ...
            >
              {timeMarkers.map((_, index) => (
                <div key={index} className="bg-border/20 w-px" />
              ))}
            </div>
          </div>
        </div>
        ...
        {/* Text Track */}
        <div className="border-border bg-muted/10 flex h-20 items-center border-b px-4">
          <div className="text-muted-foreground w-24 text-xs font-medium">
            Text
          </div>
          <div className="relative h-full flex-1">
            ...
            >
              {timeMarkers.map((_, index) => (
                <div key={index} className="bg-border/10 w-px" />
              ))}
            </div>
          </div>
        </div>
