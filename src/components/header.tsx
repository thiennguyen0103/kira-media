    ...
    <header className="bg-background border-b border-border">
      ...
      <div className="flex h-14 items-center px-6">
        ...
        <div className="flex items-center space-x-4">
          ...
          <h1 className="text-xl font-bold text-foreground">CapCut</h1>
        </div>

        {/* Center - Project Name - CapCut Style */}
        <div className="flex-1 flex items-center justify-center">
          <div className="bg-muted border border-border rounded-lg px-4 py-2">
            <h2 className="text-base font-semibold text-foreground">0729</h2>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-3">
          ...
          <Button size="sm" className="bg-primary hover:bg-primary/90 text-primary-foreground border border-primary h-9 px-4 text-sm font-medium shadow-sm">
